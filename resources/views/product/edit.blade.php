...
<div class="panel panel-widget forms-panel">
	...
	<div class="forms">
		...
		<div class="form-three widget-shadow">
			{!! Form::open(['action' => ['ProductsController@update',$data['product']->productCode], 'method' => 'POST' , 'class' => 'form-horizontal' ]) !!}
    
				<div class="form-group">
				    {{ Form::label('productname','Product Name * :',['class' => 'col-sm-2 control-label'])}}
					<div class="col-sm-8">
					{{ Form::text('productname',$data['product']->productName,['class' => 'form-control1', 'placeholder' => 'Product Name']) }}
					</div>
				</div>
				<div class="form-group">
				    {{ Form::label('mark','Mark :',['class' => 'col-sm-2 control-label'])}}
					<div class="col-sm-8">
					{{ Form::text('mark',$data['product']->mark,['class' => 'form-control1', 'placeholder' => 'Mark']) }}
					</div>
				</div>
				<div class="form-group">
				    {{ Form::label('description','Description * :',['class' => 'col-sm-2 control-label'])}}
					<div class="col-sm-8">
					{{ Form::textarea('description',$data['product']->description,['class' => 'form-control', 'placeholder' => 'Product Description']) }}
					</div>
				</div>
				<div class="form-group">
				    {{ Form::label('price','Price * :',['class' => 'col-sm-2 control-label'])}}
					<div class="col-sm-8">
					{{ Form::number('price',$data['product']->price,['class' => 'form-control1', 'placeholder' => 'Price']) }}
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
					{{ Form::number('quantity',$data['product']->quantity,['class' => 'form-control1', 'placeholder' => 'Stock Quantity']) }}
					</div>
				</div>
				<div class="form-group">
				    {{ Form::label('weight','Weight :',['class' => 'col-sm-2 control-label'])}}
					<div class="col-sm-8">
					{{ Form::number('weight',$data['product']->weight,['class' => 'form-control1', 'placeholder' => 'Weight']) }}
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-8">
					 ...
					 <option value="{{ $data['category']->idCategory }}">{{$data['category']->name}}</option>
